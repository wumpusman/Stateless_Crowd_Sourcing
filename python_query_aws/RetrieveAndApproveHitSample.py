...
whenever one is created add it to the DB
    Has length of task, how many people want to do it, and how many did it
    time last god a new person
    If completed is less than adequate amount add more
f

Ever N interval - for each task check if total number completed

For each review, check if they did it
    if they did do it, approve that, add to counter
    if they didn't reject
...
hit_id = '3J5XXLQDHMCCM8GMJMVW04QVPYTV38'
...
client = session.client(
    ...
    aws_access_key_id='AKIAJKTQYHQEWIOA3FLQ',
    aws_secret_access_key='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'
...
for assignment in assignments:
    ...
    if assignment['AssignmentStatus'] == 'Submitted':
        ...
        client.approve_assignment(
            ...
            RequesterFeedback='acceptable_users',
